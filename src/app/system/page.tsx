  ...
  return (
    <div>
      ...
      <div className="block md:flex pt-14">
        <div className="hidden md:flex flex-col justify-between md:w-1/5 pt-6 pl-6 pr-4 border-r border-gray-100 bg-[#3396D3] shadow-xl z-10 sticky top-14 h-[calc(100vh-3.5rem)]">
      ...
      text-gray-700
      hover:bg-blue-50 hover:text-[#3396D3]
      transition-colors
    "
                >
    ...
    "
          ...
          <div className="mt-8">
              ...
              <h1 className="text-sm font-medium mb-3 p-2 rounded-lg cursor-pointer text-gray-700 hover:bg-blue-50 hover:text-[#3396D3] transition-colors">
                Customization
              </h1>
              <h1 className="text-sm font-medium mb-3 p-2 rounded-lg cursor-pointer text-gray-700 hover:bg-blue-50 hover:text-[#3396D3] transition-colors">
                Tools
          ...
          <div className=" flex justify-center  py-3 mt-4 border-t border-gray-200 text-center">
            <p className="text-xs text-[#3396D3] font-semibold uppercase tracking-wider px-4 py-2 bg-white rounded-lg shadow-md">
        ...
        <div className="w-full md:w-4/5 p-4 md:p-8 font-sans bg-[#3b83f60e] min-h-screen">
          ...
          <div className="pt-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              ...
              {/* Card 4: System */}
              <div className="bg-white border border-[#3396D3] rounded-xl p-4 flex flex-col max-h-72 min-w-64 shadow-[0_2px_6px_rgba(0,0,0,0.08)] transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_12px_30px_rgba(0,0,0,0.18)]">
                ...
                <div className="grow overflow-y-auto pr-2 custom-scrollbar">
                  <ul>
                    <li className="menu-item group active-bullet p-2 rounded-md transition-colors hover:bg-blue-500 hover:text-white">
                      <span className="pi pi-box mr-2 text-sm transition-colors text-[#3396D3] group-hover:text-white"></span>
