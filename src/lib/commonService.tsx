...
export const postRequest = async (url: string, payload: any, params: any) => {
  console.log("first");
...
export const putRequest = async (url: string, payload: any, params: any) => {
...
export const patchRequest = async (url: string, payload: any, params: any) => {
